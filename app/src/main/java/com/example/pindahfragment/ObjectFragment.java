...
public class ObjectFragment extends Fragment {
    ...
    public static ObjectFragment newInstance(Mahasiswa mahasiswa) {
        ObjectFragment fragment = new ObjectFragment();
        Bundle args = new Bundle();
        args.putParcelable("m",mahasiswa);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mahasiswa=getArguments().getParcelable("m");
        }
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        textView.setText(mahasiswa.getNama());
